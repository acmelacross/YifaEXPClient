...
import com.fwh.commons.city.MyLetterListView.OnTouchingLetterChangedListener;
...
public class CityList extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		dbManager.closeDatabase();System.out.println(DBManager.DB_PATH+"--"+ DBManager.DB_NAME);
	...
	private class ListAdapter extends BaseAdapter
	{
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			if (convertView == null)
			{
				convertView = inflater.inflate(R.layout.select_city_list_item, null);
